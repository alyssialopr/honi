<header class="header">
    ...
    <div class="titre">
        ...
        <div class="head-logo" id="sidenavbar">
            ...
            <a href="http://localhost/honi/connexion.php"><button class="btn-logo" id="compte"><img class="logo" id="utilisateur" src="images/Logo/utilisateur.png" alt="logo utilisateur" ><span class="modif">Compte</span></button></a>
